...
<div id="citation-popup" style="display: none; margin-top: 15px; padding: 15px; background-color: #f8f9fa; border-radius: 5px; border: 1px solid #dee2e6;">
  <h4>Citation</h4>
  <p>Moeckli, Daniel., Mendez, Fernando., Labud, Mara., and Reimann, Nils. (Forthcoming) Mapping the European Landscape of Citizens’ Initiatives. <em>Political Studies</em>, 0(0).</p>
